...
public class ChampionTest {
    ...
    public void testCorrectChampionName() {
        assertEquals("다리우스", championList.get(0).getName());
        assertThat(championList.get(0).getName(), is("다리우스"));
    }
    ...
    public void 스트링문자열테스트(){
        ...
        String endString = "Foucs";
        assertThat(sampleString, anyOf(startsWith(startString),containsString(startString)));
        assertThat(sampleString, anyOf(endsWith(endString),containsString(endString)));
    }
    ...
    @Test
    public void shouldHaveSameChampName(){
